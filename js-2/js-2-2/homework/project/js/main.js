class ProductsList {
  ...
  _fetchProducts(){
    this.goods = [
      ...
      {id: 2, category: "Mouses", title: 'Mouse', price: 20, img:' https://img.mvideo.ru/Pdb/50048743b.jpg'},
      ...
      {id: 6, category: "Periphery", title: 'Mouse pad', price: 10, img: 'https://images-na.ssl-images-amazon.com/images/I/A16NEfK2mZL._SL1500_.jpg'}
    ];
  }
  _render(){
